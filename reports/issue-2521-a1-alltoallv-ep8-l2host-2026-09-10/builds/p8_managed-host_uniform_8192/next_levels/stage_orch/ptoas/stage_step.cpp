...
AICORE void stage_step(__gm__ int8_t* v1, __gm__ int8_t* v2, __gm__ int64_t* v3) {
  ...
  for (int64_t v25 = v8; v25 < v5; v25 += v7) {
    ...
    // pto: %2
    ;
    pto::Shape<1, 1, 1, 8, 8192> v49 = pto::Shape<1, 1, 1, 8, 8192>();
    // pto: %2
    ;
    pto::Stride<65536, 65536, 65536, 8192, 1> v50 = pto::Stride<65536, 65536, 65536, 8192, 1>();
    // pto: %2
    ;
    GlobalTensor<int8_t, pto::Shape<1, 1, 1, 8, 8192>, pto::Stride<65536, 65536, 65536, 8192, 1>, pto::Layout::ND> v51 = GlobalTensor<int8_t, pto::Shape<1, 1, 1, 8, 8192>, pto::Stride<65536, 65536, 65536, 8192, 1>, pto::Layout::ND>((__gm__ int8_t*) v2, v49, v50);
