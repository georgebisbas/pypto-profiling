...
def _inline_inputs():
    ...
    inputs__ssa_v0 = torch.randint(0, 8, (8, 8, 1048576), dtype=torch.int8)
    send_counts__ssa_v0 = torch.randint(0, 8, (8, 8, 1), dtype=torch.int32)
    outputs__ssa_v0 = torch.zeros((8, 8, 1048576), dtype=torch.int8)
    recv_outputs__ssa_v0 = torch.zeros((8, 8, 1), dtype=torch.int32)
    return [inputs__ssa_v0, send_counts__ssa_v0, outputs__ssa_v0, recv_outputs__ssa_v0]


def _user_compare(inputs__ssa_v0, send_counts__ssa_v0, outputs__ssa_v0, recv_outputs__ssa_v0):
