...
AICORE void stage_step(__gm__ int8_t* v1, __gm__ int32_t* v2, __gm__ int8_t* v3, __gm__ int32_t* v4, __gm__ int64_t* v5, __gm__ int64_t* v6) {
  ...
  for (int64_t v31 = v11; v31 < v8; v31 += v10) {
    ...
    // pto: %2
    ;
    pto::Shape<1, 1, 1, 8, 65536> v55 = pto::Shape<1, 1, 1, 8, 65536>();
    // pto: %2
    ;
    pto::Stride<524288, 524288, 524288, 65536, 1> v56 = pto::Stride<524288, 524288, 524288, 65536, 1>();
    // pto: %2
    ;
    GlobalTensor<int8_t, pto::Shape<1, 1, 1, 8, 65536>, pto::Stride<524288, 524288, 524288, 65536, 1>, pto::Layout::ND> v57 = GlobalTensor<int8_t, pto::Shape<1, 1, 1, 8, 65536>, pto::Stride<524288, 524288, 524288, 65536, 1>, pto::Layout::ND>((__gm__ int8_t*) v3, v55, v56);
  ...
  for (int64_t v128 = v11; v128 < v8; v128 += v10) {
    ...
    // pto: %counts__ssa_v0_pview
    ;
    pto::Stride<8, 8, 8, 1, 8> v131 = pto::Stride<8, 8, 8, 1, 8>();
    // pto: %counts__ssa_v0_pview
    ;
    GlobalTensor<int32_t, pto::Shape<1, 1, 1, 8, 1>, pto::Stride<8, 8, 8, 1, 8>, pto::Layout::DN> v132 = GlobalTensor<int32_t, pto::Shape<1, 1, 1, 8, 1>, pto::Stride<8, 8, 8, 1, 8>, pto::Layout::DN>((__gm__ int32_t*) v4, v130, v131);
