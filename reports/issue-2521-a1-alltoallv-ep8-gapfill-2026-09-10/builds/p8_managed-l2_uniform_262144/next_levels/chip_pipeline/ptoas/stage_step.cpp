...
AICORE void stage_step(__gm__ int8_t* v1, __gm__ int32_t* v2, __gm__ int8_t* v3, __gm__ int32_t* v4, __gm__ int64_t* v5, __gm__ int64_t* v6) {
  ...
  for (int64_t v43 = v11; v43 < v8; v43 += v10) {
    ...
    // pto: %2
    ;
    pto::Shape<1, 1, 1, 8, 262144> v67 = pto::Shape<1, 1, 1, 8, 262144>();
    // pto: %2
    ;
    pto::Stride<2097152, 2097152, 2097152, 262144, 1> v68 = pto::Stride<2097152, 2097152, 2097152, 262144, 1>();
    // pto: %2
    ;
    GlobalTensor<int8_t, pto::Shape<1, 1, 1, 8, 262144>, pto::Stride<2097152, 2097152, 2097152, 262144, 1>, pto::Layout::ND> v69 = GlobalTensor<int8_t, pto::Shape<1, 1, 1, 8, 262144>, pto::Stride<2097152, 2097152, 2097152, 262144, 1>, pto::Layout::ND>((__gm__ int8_t*) v3, v67, v68);
  ...
  for (int64_t v416 = v11; v416 < v8; v416 += v10) {
    ...
    ;
    pto::Shape<1, 1, 1, 8, 1> v418 = pto::Shape<1, 1, 1, 8, 1>();
    // pto: %counts__ssa_v0_pview
    ;
    pto::Stride<8, 8, 8, 1, 8> v419 = pto::Stride<8, 8, 8, 1, 8>();
    // pto: %counts__ssa_v0_pview
    ;
    GlobalTensor<int32_t, pto::Shape<1, 1, 1, 8, 1>, pto::Stride<8, 8, 8, 1, 8>, pto::Layout::DN> v420 = GlobalTensor<int32_t, pto::Shape<1, 1, 1, 8, 1>, pto::Stride<8, 8, 8, 1, 8>, pto::Layout::DN>((__gm__ int32_t*) v4, v418, v419);
