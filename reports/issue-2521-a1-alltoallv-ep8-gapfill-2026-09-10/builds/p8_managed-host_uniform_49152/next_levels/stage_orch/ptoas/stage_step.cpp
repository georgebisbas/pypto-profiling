...
AICORE void stage_step(__gm__ int8_t* v1, __gm__ int8_t* v2, __gm__ int64_t* v3) {
  ...
  for (int64_t v27 = v8; v27 < v5; v27 += v7) {
    ...
    // pto: %2
    ;
    pto::Shape<1, 1, 1, 8, 49152> v51 = pto::Shape<1, 1, 1, 8, 49152>();
    // pto: %2
    ;
    pto::Stride<393216, 393216, 393216, 49152, 1> v52 = pto::Stride<393216, 393216, 393216, 49152, 1>();
    // pto: %2
    ;
    GlobalTensor<int8_t, pto::Shape<1, 1, 1, 8, 49152>, pto::Stride<393216, 393216, 393216, 49152, 1>, pto::Layout::ND> v53 = GlobalTensor<int8_t, pto::Shape<1, 1, 1, 8, 49152>, pto::Stride<393216, 393216, 393216, 49152, 1>, pto::Layout::ND>((__gm__ int8_t*) v2, v51, v52);
    ...
    // pto: %tile__ssa_v1
    ;
    Tile<TileType::Vec, int8_t, 1, 16384, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null, CompactMode::Null> v55 = Tile<TileType::Vec, int8_t, 1, 16384, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null, CompactMode::Null>(v7, v9);
    // pto: %tile__ssa_v1
    ;
    ...
    // pto: %4
    ;
    pto::Shape<1, 1, 1, 1, -1> v64 = pto::Shape<1, 1, 1, 1, -1>(v59, v60, v61, v7, v9);
    // pto: %4
    ;
    ...
    // pto: %stage__ssa_v3_pview
    ;
    pto::Shape<1, 1, 1, 1, -1> v74 = pto::Shape<1, 1, 1, 1, -1>(v69, v70, v71, v7, v9);
    // pto: %stage__ssa_v3_pview
    ;
    ...
    // pto: %tile__ssa_v2
    ;
    Tile<TileType::Vec, int8_t, 1, 16384, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null, CompactMode::Null> v78 = Tile<TileType::Vec, int8_t, 1, 16384, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null, CompactMode::Null>(v7, v9);
    // pto: %tile__ssa_v2
    ;
    ...
    // pto: %8
    ;
    __gm__ int8_t* v81 = PTOAS__GLOBAL_TENSOR_DATA(v18);
    // pto: %8
    ;
    const int64_t v82 = 1;
    // pto: %8
    ...
    // pto: %8
    ;
    GlobalTensor<int8_t, pto::Shape<1, 1, 1, 1, -1>, pto::Stride<-1, -1, -1, -1, -1>, pto::Layout::ND> v89 = GlobalTensor<int8_t, pto::Shape<1, 1, 1, 1, -1>, pto::Stride<-1, -1, -1, -1, -1>, pto::Layout::ND>(v81 + (v80 + v30 * v6 + v10 * v7), v87, v88);
    ...
    // pto: %stage__ssa_v4_pview
    ;
    __gm__ int8_t* v91 = PTOAS__GLOBAL_TENSOR_DATA(v26);
    // pto: %stage__ssa_v4_pview
    ;
    const int64_t v92 = 1;
    // pto: %stage__ssa_v4_pview
    ...
    // pto: %stage__ssa_v4_pview
    ;
    pto::Shape<1, 1, 1, 1, -1> v97 = pto::Shape<1, 1, 1, 1, -1>(v92, v93, v94, v7, v9);
    // pto: %stage__ssa_v4_pview
    ;
    pto::Stride<-1, -1, -1, -1, -1> v98 = pto::Stride<-1, -1, -1, -1, -1>(v93 * v96, v96, v95, v6, v7);
    // pto: %stage__ssa_v4_pview
    ;
    GlobalTensor<int8_t, pto::Shape<1, 1, 1, 1, -1>, pto::Stride<-1, -1, -1, -1, -1>, pto::Layout::ND> v99 = GlobalTensor<int8_t, pto::Shape<1, 1, 1, 1, -1>, pto::Stride<-1, -1, -1, -1, -1>, pto::Layout::ND>(v91 + (v90 + v30 * v6 + v10 * v7), v97, v98);
    wait_flag(PIPE_MTE2, PIPE_MTE3, EVENT_ID2);
    TSTORE(v99, v78);
    set_flag(PIPE_MTE3, PIPE_MTE2, EVENT_ID0);
    __gm__ int8_t* v100 = PTOAS__GLOBAL_TENSOR_DATA(v53);
    PTOAS__DCCI_SINGLE_CACHE_LINE(v100);
    pipe_barrier(PIPE_ALL);
    dsb(DSB_DDR);
  }
  wait_flag(PIPE_MTE3, PIPE_MTE2, EVENT_ID0);
