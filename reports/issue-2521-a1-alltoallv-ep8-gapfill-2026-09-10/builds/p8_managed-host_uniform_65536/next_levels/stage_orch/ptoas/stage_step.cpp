...
AICORE void stage_step(__gm__ int8_t* v1, __gm__ int8_t* v2, __gm__ int64_t* v3) {
  ...
  for (int64_t v28 = v8; v28 < v5; v28 += v7) {
    ...
    // pto: %2
    ;
    pto::Shape<1, 1, 1, 8, 65536> v52 = pto::Shape<1, 1, 1, 8, 65536>();
    // pto: %2
    ;
    pto::Stride<524288, 524288, 524288, 65536, 1> v53 = pto::Stride<524288, 524288, 524288, 65536, 1>();
    // pto: %2
    ;
    GlobalTensor<int8_t, pto::Shape<1, 1, 1, 8, 65536>, pto::Stride<524288, 524288, 524288, 65536, 1>, pto::Layout::ND> v54 = GlobalTensor<int8_t, pto::Shape<1, 1, 1, 8, 65536>, pto::Stride<524288, 524288, 524288, 65536, 1>, pto::Layout::ND>((__gm__ int8_t*) v2, v52, v53);
