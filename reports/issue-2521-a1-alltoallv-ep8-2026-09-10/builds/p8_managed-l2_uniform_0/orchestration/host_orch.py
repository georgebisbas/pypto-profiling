...
def host_orch(orch, _args, config, *, tensors, callables, sub_ids, _keep, world_size, _domain_provider=None):
    with (_domain_provider or orch.allocate_domain)(
        ...
        buffers=[
            CommBufferSpec(name="stage_buf__ssa_v0", dtype="opaque", count=8419840, nbytes=(((8419840 + 31) // 32) * 32)),
        ...
        for r__idx_v0 in range(0, t__tmp_v0, 1):
            ...
            tensors["t__tmp_v3"] = tensors["outputs__ssa_v0"][r__idx_v0, 0:2024, 0:4160]
            ...
            _ta_0.add_tensor(__comm_d0[r__idx_v0].buffers["stage_buf__ssa_v0"].tensor(shapes=(2024, 4160), dtype=DataType.INT8), TensorArgType.INOUT)
            _ta_0.add_tensor(__comm_d0[r__idx_v0].buffers["data_buf__ssa_v0"].tensor(shapes=(2024, 4160), dtype=DataType.INT8), TensorArgType.INOUT)
