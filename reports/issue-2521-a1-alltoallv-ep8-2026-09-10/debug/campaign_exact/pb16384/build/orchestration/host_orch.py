...
def host_orch(orch, _args, config, *, tensors, callables, sub_ids, _keep, world_size, _domain_provider=None):
    with (_domain_provider or orch.allocate_domain)(
        ...
        for r__idx_v0 in range(0, t__tmp_v0, 1):
            ...
            tensors["t__tmp_v3"] = tensors["outputs__ssa_v0"][r__idx_v0, 0:8, 0:16384]
            ...
            _ta_0.add_tensor(__comm_d0[r__idx_v0].buffers["stage_buf__ssa_v0"].tensor(shapes=(8, 16384), dtype=DataType.INT8), TensorArgType.INOUT)
            _ta_0.add_tensor(__comm_d0[r__idx_v0].buffers["data_buf__ssa_v0"].tensor(shapes=(8, 16384), dtype=DataType.INT8), TensorArgType.INOUT)
