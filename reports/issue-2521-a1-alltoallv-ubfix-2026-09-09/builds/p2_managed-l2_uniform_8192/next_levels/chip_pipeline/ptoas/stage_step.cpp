...
AICORE void stage_step(__gm__ int8_t* v1, __gm__ int32_t* v2, __gm__ int8_t* v3, __gm__ int32_t* v4, __gm__ int64_t* v5, __gm__ int64_t* v6) {
  ...
  for (int64_t v28 = v11; v28 < v8; v28 += v10) {
    ...
    // pto: %2
    ;
    pto::Shape<1, 1, 1, 2, 8192> v52 = pto::Shape<1, 1, 1, 2, 8192>();
    // pto: %2
    ;
    pto::Stride<16384, 16384, 16384, 8192, 1> v53 = pto::Stride<16384, 16384, 16384, 8192, 1>();
    // pto: %2
    ;
    GlobalTensor<int8_t, pto::Shape<1, 1, 1, 2, 8192>, pto::Stride<16384, 16384, 16384, 8192, 1>, pto::Layout::ND> v54 = GlobalTensor<int8_t, pto::Shape<1, 1, 1, 2, 8192>, pto::Stride<16384, 16384, 16384, 8192, 1>, pto::Layout::ND>((__gm__ int8_t*) v3, v52, v53);
