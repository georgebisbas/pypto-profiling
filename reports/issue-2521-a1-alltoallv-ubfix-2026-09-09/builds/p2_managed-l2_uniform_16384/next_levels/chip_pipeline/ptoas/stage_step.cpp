...
AICORE void stage_step(__gm__ int8_t* v1, __gm__ int32_t* v2, __gm__ int8_t* v3, __gm__ int32_t* v4, __gm__ int64_t* v5, __gm__ int64_t* v6) {
  ...
  for (int64_t v28 = v11; v28 < v8; v28 += v10) {
    ...
    // pto: %2
    ;
    pto::Shape<1, 1, 1, 2, 16384> v52 = pto::Shape<1, 1, 1, 2, 16384>();
    // pto: %2
    ;
    pto::Stride<32768, 32768, 32768, 16384, 1> v53 = pto::Stride<32768, 32768, 32768, 16384, 1>();
    // pto: %2
    ;
    GlobalTensor<int8_t, pto::Shape<1, 1, 1, 2, 16384>, pto::Stride<32768, 32768, 32768, 16384, 1>, pto::Layout::ND> v54 = GlobalTensor<int8_t, pto::Shape<1, 1, 1, 2, 16384>, pto::Stride<32768, 32768, 32768, 16384, 1>, pto::Layout::ND>((__gm__ int8_t*) v3, v52, v53);
  ...
  for (int64_t v56 = v11; v56 < v8; v56 += v10) {
    ...
    ;
    pto::Shape<1, 1, 1, 2, 1> v58 = pto::Shape<1, 1, 1, 2, 1>();
    // pto: %counts__ssa_v0_pview
    ;
    pto::Stride<2, 2, 2, 1, 2> v59 = pto::Stride<2, 2, 2, 1, 2>();
    // pto: %counts__ssa_v0_pview
    ;
    GlobalTensor<int32_t, pto::Shape<1, 1, 1, 2, 1>, pto::Stride<2, 2, 2, 1, 2>, pto::Layout::DN> v60 = GlobalTensor<int32_t, pto::Shape<1, 1, 1, 2, 1>, pto::Stride<2, 2, 2, 1, 2>, pto::Layout::DN>((__gm__ int32_t*) v4, v58, v59);
