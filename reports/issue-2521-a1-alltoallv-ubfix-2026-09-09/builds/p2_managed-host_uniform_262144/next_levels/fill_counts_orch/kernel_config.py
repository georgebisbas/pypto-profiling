...
ORCHESTRATION = {
	"source": str(_ROOT_DIR / "orchestration" / "fill_counts_orch.cpp"),
	"function_name": "aicpu_orchestration_entry",
	"signature": [_D.IN, _D.OUT],
}

KERNELS = [
	{"func_id": 0, "name": "fill_counts_step", "source": str(_ROOT_DIR / "kernels" / "aiv" / "fill_counts_step.cpp"), "core_type": "aiv", "signature": [_D.IN, _D.OUT]},
]
