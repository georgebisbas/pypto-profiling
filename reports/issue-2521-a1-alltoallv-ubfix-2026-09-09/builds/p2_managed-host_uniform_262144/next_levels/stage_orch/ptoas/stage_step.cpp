...
AICORE void stage_step(__gm__ int8_t* v1, __gm__ int8_t* v2, __gm__ int64_t* v3) {
  ...
  for (int64_t v40 = v8; v40 < v5; v40 += v7) {
    ...
    // pto: %2
    ;
    pto::Shape<1, 1, 1, 2, 262144> v64 = pto::Shape<1, 1, 1, 2, 262144>();
    // pto: %2
    ;
    pto::Stride<524288, 524288, 524288, 262144, 1> v65 = pto::Stride<524288, 524288, 524288, 262144, 1>();
    // pto: %2
    ;
    GlobalTensor<int8_t, pto::Shape<1, 1, 1, 2, 262144>, pto::Stride<524288, 524288, 524288, 262144, 1>, pto::Layout::ND> v66 = GlobalTensor<int8_t, pto::Shape<1, 1, 1, 2, 262144>, pto::Stride<524288, 524288, 524288, 262144, 1>, pto::Layout::ND>((__gm__ int8_t*) v2, v64, v65);
