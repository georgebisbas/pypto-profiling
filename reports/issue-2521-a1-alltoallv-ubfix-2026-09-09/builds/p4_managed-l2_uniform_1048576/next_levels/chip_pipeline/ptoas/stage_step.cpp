...
AICORE void stage_step(__gm__ int8_t* v1, __gm__ int32_t* v2, __gm__ int8_t* v3, __gm__ int32_t* v4, __gm__ int64_t* v5, __gm__ int64_t* v6) {
  ...
  for (int64_t v91 = v11; v91 < v8; v91 += v10) {
    ...
    // pto: %2
    ;
    pto::Shape<1, 1, 1, 4, 1048576> v115 = pto::Shape<1, 1, 1, 4, 1048576>();
    // pto: %2
    ;
    pto::Stride<4194304, 4194304, 4194304, 1048576, 1> v116 = pto::Stride<4194304, 4194304, 4194304, 1048576, 1>();
    // pto: %2
    ;
    GlobalTensor<int8_t, pto::Shape<1, 1, 1, 4, 1048576>, pto::Stride<4194304, 4194304, 4194304, 1048576, 1>, pto::Layout::ND> v117 = GlobalTensor<int8_t, pto::Shape<1, 1, 1, 4, 1048576>, pto::Stride<4194304, 4194304, 4194304, 1048576, 1>, pto::Layout::ND>((__gm__ int8_t*) v3, v115, v116);
  ...
  for (int64_t v1568 = v11; v1568 < v8; v1568 += v10) {
    ...
    ;
    pto::Shape<1, 1, 1, 4, 1> v1570 = pto::Shape<1, 1, 1, 4, 1>();
    // pto: %counts__ssa_v0_pview
    ;
    pto::Stride<4, 4, 4, 1, 4> v1571 = pto::Stride<4, 4, 4, 1, 4>();
    // pto: %counts__ssa_v0_pview
    ;
    GlobalTensor<int32_t, pto::Shape<1, 1, 1, 4, 1>, pto::Stride<4, 4, 4, 1, 4>, pto::Layout::DN> v1572 = GlobalTensor<int32_t, pto::Shape<1, 1, 1, 4, 1>, pto::Stride<4, 4, 4, 1, 4>, pto::Layout::DN>((__gm__ int32_t*) v4, v1570, v1571);
