...
ORCHESTRATION = {
	"source": str(_ROOT_DIR / "orchestration" / "consume_orch.cpp"),
	"function_name": "aicpu_orchestration_entry",
	"signature": [_D.IN, _D.IN, _D.OUT, _D.OUT],
}

KERNELS = [
	{"func_id": 0, "name": "consume_step", "source": str(_ROOT_DIR / "kernels" / "aiv" / "consume_step.cpp"), "core_type": "aiv", "signature": [_D.IN, _D.IN, _D.OUT, _D.OUT]},
]
