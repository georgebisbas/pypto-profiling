...
def _inline_inputs():
    ...
    inputs__ssa_v0 = torch.randint(0, 8, (2, 2, 1048576), dtype=torch.int8)
    send_counts__ssa_v0 = torch.randint(0, 8, (2, 2, 1), dtype=torch.int32)
    outputs__ssa_v0 = torch.zeros((2, 2, 1048576), dtype=torch.int8)
    recv_outputs__ssa_v0 = torch.zeros((2, 2, 1), dtype=torch.int32)
