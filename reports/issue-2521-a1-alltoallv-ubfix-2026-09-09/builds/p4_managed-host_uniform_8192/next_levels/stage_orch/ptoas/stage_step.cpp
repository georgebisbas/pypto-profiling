...
AICORE void stage_step(__gm__ int8_t* v1, __gm__ int8_t* v2, __gm__ int64_t* v3) {
  ...
  for (int64_t v25 = v8; v25 < v5; v25 += v7) {
    // pto: %tile__ssa_v0
    ;
    Tile<TileType::Vec, int8_t, 1, 8192, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null, CompactMode::Null> v26 = Tile<TileType::Vec, int8_t, 1, 8192, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null, CompactMode::Null>(v7, v6);
    // pto: %tile__ssa_v0
    ;
    ...
    // pto: %2
    ;
    pto::Shape<1, 1, 1, 4, 8192> v49 = pto::Shape<1, 1, 1, 4, 8192>();
    // pto: %2
    ;
    pto::Stride<32768, 32768, 32768, 8192, 1> v50 = pto::Stride<32768, 32768, 32768, 8192, 1>();
    // pto: %2
    ;
    GlobalTensor<int8_t, pto::Shape<1, 1, 1, 4, 8192>, pto::Stride<32768, 32768, 32768, 8192, 1>, pto::Layout::ND> v51 = GlobalTensor<int8_t, pto::Shape<1, 1, 1, 4, 8192>, pto::Stride<32768, 32768, 32768, 8192, 1>, pto::Layout::ND>((__gm__ int8_t*) v2, v49, v50);
