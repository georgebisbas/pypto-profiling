...
AICORE void stage_step(__gm__ int8_t* v1, __gm__ int32_t* v2, __gm__ int8_t* v3, __gm__ int32_t* v4, __gm__ int64_t* v5, __gm__ int64_t* v6) {
  ...
  for (int64_t v12 = v11; v12 < v8; v12 += v10) {
    ...
    // pto: %2
    ;
    pto::Shape<1, 1, 1, 4, 1024> v26 = pto::Shape<1, 1, 1, 4, 1024>();
    // pto: %2
    ;
    pto::Stride<4096, 4096, 4096, 1024, 1> v27 = pto::Stride<4096, 4096, 4096, 1024, 1>();
    // pto: %2
    ;
    GlobalTensor<int8_t, pto::Shape<1, 1, 1, 4, 1024>, pto::Stride<4096, 4096, 4096, 1024, 1>, pto::Layout::ND> v28 = GlobalTensor<int8_t, pto::Shape<1, 1, 1, 4, 1024>, pto::Stride<4096, 4096, 4096, 1024, 1>, pto::Layout::ND>((__gm__ int8_t*) v3, v26, v27);
