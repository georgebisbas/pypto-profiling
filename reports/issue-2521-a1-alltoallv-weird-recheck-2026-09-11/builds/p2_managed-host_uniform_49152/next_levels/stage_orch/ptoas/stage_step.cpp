...
AICORE void stage_step(__gm__ int8_t* v1, __gm__ int8_t* v2, __gm__ int64_t* v3) {
  ...
  for (int64_t v27 = v8; v27 < v5; v27 += v7) {
    ...
    // pto: %2
    ;
    pto::Shape<1, 1, 1, 2, 49152> v51 = pto::Shape<1, 1, 1, 2, 49152>();
    // pto: %2
    ;
    pto::Stride<98304, 98304, 98304, 49152, 1> v52 = pto::Stride<98304, 98304, 98304, 49152, 1>();
    // pto: %2
    ;
    GlobalTensor<int8_t, pto::Shape<1, 1, 1, 2, 49152>, pto::Stride<98304, 98304, 98304, 49152, 1>, pto::Layout::ND> v53 = GlobalTensor<int8_t, pto::Shape<1, 1, 1, 2, 49152>, pto::Stride<98304, 98304, 98304, 49152, 1>, pto::Layout::ND>((__gm__ int8_t*) v2, v51, v52);
