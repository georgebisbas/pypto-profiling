...
AICORE void stage_step(__gm__ int8_t* v1, __gm__ int32_t* v2, __gm__ int8_t* v3, __gm__ int32_t* v4, __gm__ int64_t* v5, __gm__ int64_t* v6) {
  ...
  for (int64_t v29 = v11; v29 < v8; v29 += v10) {
    ...
    // pto: %2
    ;
    pto::Shape<1, 1, 1, 2, 32768> v53 = pto::Shape<1, 1, 1, 2, 32768>();
    // pto: %2
    ;
    pto::Stride<65536, 65536, 65536, 32768, 1> v54 = pto::Stride<65536, 65536, 65536, 32768, 1>();
    // pto: %2
    ;
    GlobalTensor<int8_t, pto::Shape<1, 1, 1, 2, 32768>, pto::Stride<65536, 65536, 65536, 32768, 1>, pto::Layout::ND> v55 = GlobalTensor<int8_t, pto::Shape<1, 1, 1, 2, 32768>, pto::Stride<65536, 65536, 65536, 32768, 1>, pto::Layout::ND>((__gm__ int8_t*) v3, v53, v54);
  ...
  for (int64_t v80 = v11; v80 < v8; v80 += v10) {
    ...
    ;
    pto::Shape<1, 1, 1, 2, 1> v82 = pto::Shape<1, 1, 1, 2, 1>();
    // pto: %counts__ssa_v0_pview
    ;
    pto::Stride<2, 2, 2, 1, 2> v83 = pto::Stride<2, 2, 2, 1, 2>();
    // pto: %counts__ssa_v0_pview
    ;
    GlobalTensor<int32_t, pto::Shape<1, 1, 1, 2, 1>, pto::Stride<2, 2, 2, 1, 2>, pto::Layout::DN> v84 = GlobalTensor<int32_t, pto::Shape<1, 1, 1, 2, 1>, pto::Stride<2, 2, 2, 1, 2>, pto::Layout::DN>((__gm__ int32_t*) v4, v82, v83);
