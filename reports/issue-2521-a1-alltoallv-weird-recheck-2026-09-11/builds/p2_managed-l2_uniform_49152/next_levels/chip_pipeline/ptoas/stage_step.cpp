...
AICORE void stage_step(__gm__ int8_t* v1, __gm__ int32_t* v2, __gm__ int8_t* v3, __gm__ int32_t* v4, __gm__ int64_t* v5, __gm__ int64_t* v6) {
  ...
  for (int64_t v30 = v11; v30 < v8; v30 += v10) {
    ...
    // pto: %2
    ;
    pto::Shape<1, 1, 1, 2, 49152> v54 = pto::Shape<1, 1, 1, 2, 49152>();
    // pto: %2
    ;
    pto::Stride<98304, 98304, 98304, 49152, 1> v55 = pto::Stride<98304, 98304, 98304, 49152, 1>();
    // pto: %2
    ;
    GlobalTensor<int8_t, pto::Shape<1, 1, 1, 2, 49152>, pto::Stride<98304, 98304, 98304, 49152, 1>, pto::Layout::ND> v56 = GlobalTensor<int8_t, pto::Shape<1, 1, 1, 2, 49152>, pto::Stride<98304, 98304, 98304, 49152, 1>, pto::Layout::ND>((__gm__ int8_t*) v3, v54, v55);
  ...
  for (int64_t v104 = v11; v104 < v8; v104 += v10) {
    ...
    ;
    pto::Shape<1, 1, 1, 2, 1> v106 = pto::Shape<1, 1, 1, 2, 1>();
    // pto: %counts__ssa_v0_pview
    ;
    pto::Stride<2, 2, 2, 1, 2> v107 = pto::Stride<2, 2, 2, 1, 2>();
    // pto: %counts__ssa_v0_pview
    ;
    GlobalTensor<int32_t, pto::Shape<1, 1, 1, 2, 1>, pto::Stride<2, 2, 2, 1, 2>, pto::Layout::DN> v108 = GlobalTensor<int32_t, pto::Shape<1, 1, 1, 2, 1>, pto::Stride<2, 2, 2, 1, 2>, pto::Layout::DN>((__gm__ int32_t*) v4, v106, v107);
